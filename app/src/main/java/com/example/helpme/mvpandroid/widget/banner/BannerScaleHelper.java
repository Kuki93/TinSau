...
public class BannerScaleHelper {
    ...
    public void attachToRecyclerView(final BannerRecyclerView mRecyclerView) {
        ...
        this.mRecyclerView.attachToScaleHelper(this);
    ...
    private void initWidth() {
        mRecyclerView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                mCardWidth = mCardGalleryWidth - DensityUtils.dip2px(mContext, 2 * (mPagePadding + mShowLeftCardWidth));
    ...
    public void scrollToPosition(int pos) {
        ...
        //mRecyclerView.getLayoutManager()).scrollToPositionWithOffset 方法不会回调  RecyclerView.OnScrollListener 
        // 的onScrollStateChanged方法,是瞬间跳到指定位置
        //mRecyclerView.smoothScrollToPosition 方法会回调  RecyclerView.OnScrollListener 的onScrollStateChanged方法 
        // 并且是自动居中，有滚动过程的滑动到指定位置
        ((LinearLayoutManager) mRecyclerView.getLayoutManager()).
                scrollToPositionWithOffset(pos,
                        DensityUtils.dip2px(mContext, mPagePadding + mShowLeftCardWidth));
        mCurrentItemOffset = 0;
        mLastPos = pos;
        //认为是一次滑动停止 这里可以写滑动停止回调
        mRecyclerView.dispatchOnPageSelected(mLastPos);
    ...
    private static class CardLinearSnapHelper extends LinearSnapHelper {
        ...
        @Override
        public int[] calculateDistanceToFinalSnap(@NonNull RecyclerView.LayoutManager layoutManager, @NonNull View
                targetView) {
    ...
    private static class BannerLoopHandler extends Handler {
        
        private BannerScaleHelper mHelper;
        
        private BannerLoopHandler(BannerScaleHelper helper) {
            mHelper = helper;
        }
        
        @Override
        public void handleMessage(Message msg) {
            mHelper.setCurrentItem(mHelper.getCurrentItem() + 1, true);
            sendEmptyMessageDelayed(0, 2000);
        }
    }
    
    
    private final BannerLoopHandler mHandler = new BannerLoopHandler(this);
    
    public void onCancelBannerLoop() {
