...
/**
 * @Created by helpme on 2018/1/31.
 * @Description 文字流式布局
 */
public class FlowLayout extends RelativeLayout {
    ...
    // 关键字背景
    private int backgroundResource = R.drawable.shape_flow;
    // 关键字水平padding，单位为dp
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attr == R.styleable.FlowLayoutAttrs_horizontalSpacing) {
                ...
                backgroundResource = typedArray.getResourceId(attr, R.drawable.shape_flow);
    ...
    public void setFlowLayout(final List<AllCityCode> mAllCityCode, final OnItemClickListener onItemClickListener) {
        for (int i = 0; i < mAllCityCode.size(); i++) {
            final TextView tv = new TextView(getContext());
            
            // 设置TextView属性
            tv.setText(mAllCityCode.get(i).getCountyname());
            tv.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
            tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
            tv.setGravity(Gravity.CENTER);
            tv.setPadding(textPaddingH, textPaddingV, textPaddingH, textPaddingV);
            tv.setClickable(true);
            if (mAllCityCode.get(i).isCheck()) {
                tv.setTextColor(getResources().getColor(R.color.colorWhite));
                tv.setBackgroundResource(R.drawable.shape_flow_select);
            } else {
            ...
            if (onItemClickListener != null) {
                ...
                tv.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mAllCityCode.get(finalI).isCheck())
                            onItemClickListener.onItemClick(null);
                        else {
                            mAllCityCode.get(finalI).setCheck(true);
                            onItemClickListener.onItemClick(mAllCityCode.get(finalI));
                        }
    ...
    public interface OnItemClickListener {
        void onItemClick(AllCityCode mAllCityCode);
    }
